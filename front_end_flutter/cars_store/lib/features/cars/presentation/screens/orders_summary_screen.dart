                  ...
                  Expanded(
                    child: Column(
                     ...
                     SizedBox(
                      ...
                      suffix: Image.asset('assets/images/mastercard.jpg'),
                      ),
                      SizedBox(
                        height: 30.h,
                      ),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(blurRadius: 1.r,color:Colors.grey.shade100)
                          ]
                        ),
                      ),
                    ),
                                 ...
                                 Padding(
            padding: EdgeInsets.only(left: 260.w, top: 30.h, right: 22.w),
            child: Container(
              height: 65.h,
              width: 342.w,
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(5), color: const Color.fromRGBO(31, 41, 55, 1)),
              child: MaterialButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>PurchaseEnd(),
                  )
                  );
                },
                child: Text(
